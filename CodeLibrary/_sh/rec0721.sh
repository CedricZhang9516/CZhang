...
Folder_A="/bes3fs/offline/data/raw/round02/"  
for file_a in ${Folder_A}/*; do  
	...
	then
	raw_evt_filter.exe "run_${temp_file3}.txt" "/bes3fs/offline/data/raw/round02/${temp_file1}/run_000${temp_file3}_All_*.raw"
        fi
    fi    
