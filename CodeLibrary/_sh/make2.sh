...
Folder_A="/Users/zhangce/hep_work/work_etac/offline_ana/srun"
...
echo ' 
"/afs/ihep.ac.cn/users/z/zhangce/WorkArea/TestRelease/TestRelease-00-00-80/run/recraw/run/_raw/\c' >> "${Folder_A}/${i}.txtbak"

echo "${temp_file1}.raw\c">>"${Folder_A}/${i}.txtbak"

echo '"'>>"${Folder_A}/${i}.txtbak"
echo ','>>"${Folder_A}/${i}.txtbak"
...
sed '$d' "${Folder_A}/${i}.txtbak">>"${Folder_A}/${i}.txt"
#sed '$d' "${Folder_A}/${i}.txt"
echo '};
//output data file
EventPreSelect.WriteRec=true;
WriteRec.digiRootOutputFile="/afs/ihep.ac.cn/users/z/zhangce/WorkArea/TestRelease/TestRelease-00-00-80/run/recraw/rec0517/rec_'>>"${Folder_A}/${i}.txt"
echo "${i}.rec">>"${Folder_A}/${i}.txt"
echo ' ";'>> "${Folder_A}/${i}.txt"
echo 'EventCnvSvc.digiRootOutputFile="/afs/ihep.ac.cn/users/z/zhangce/WorkArea/TestRelease/TestRelease-00-00-80/run/recraw/rec0517/rec_'>>"${Folder_A}/${i}.txt"
echo "${i}.tmp">>"${Folder_A}/${i}.txt"
echo '";
//Number of events to be processed (default is 10)
ApplicationMgr.EvtMax = 1000;'>>"${Folder_A}/${i}.txt"
