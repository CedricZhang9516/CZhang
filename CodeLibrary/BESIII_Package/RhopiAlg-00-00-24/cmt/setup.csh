...
${CMTROOT}/mgr/cmt setup -csh -pack=RhopiAlg -version=RhopiAlg-00-00-24 -path=/home/zhangc/work14/work664/Analysis/Physics  -no_cleanup $* >${tempfile}; source ${tempfile}
/bin/rm -f ${tempfile}
